...
-- 2017-01-01,SChen,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_SChen')
	 Begin 
	  Alter Database [Assignment07DB_SChen] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_SChen;
	 End
	Create Database Assignment07DB_SChen;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_SChen;
...
Create
 ...
 Returns Table
 As
  Return Select ProductName, InventoryDate, InventoryCount, PreviousMonthCount, CountKPI
   From vProductInventoriesWithPreviousMonthCountsWithKPIs
    Where CountKPI = @KPIValue;
go
